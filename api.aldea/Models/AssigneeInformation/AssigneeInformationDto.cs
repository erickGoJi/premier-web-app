...
namespace api.premier.Models.AssigneeInformation
{
    public class AssigneeInformationDto
    {
        ...
        public virtual CityDto HomeCity { get; set; }
        public virtual CountriesDto HomeCountry { get; set; }
        public virtual CatCityDto HostCity { get; set; }
        public virtual CatCountryDto HostCountryNavigation { get; set; }
        //public virtual CatCountryDto HomeCountry { get; set; }
        //public virtual CatCityDto HostCity { get; set; }
        public virtual CatSexDto Sex { get; set; }

         public int? MobilePhoneCodeId { get; set; }
        public int? WorkPhoneCodeId { get; set; }
