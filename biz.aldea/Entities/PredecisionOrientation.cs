...
{
    public partial class PredecisionOrientation
    {
        public PredecisionOrientation()
        {
            ...
            ExtensionPredecisionOrientations = new HashSet<ExtensionPredecisionOrientation>();
            KeyReloDetailServices = new HashSet<KeyReloDetailService>();
            ReminderPredecisionOrientations = new HashSet<ReminderPredecisionOrientation>();
        ...
        public virtual ICollection<ExtensionPredecisionOrientation> ExtensionPredecisionOrientations { get; set; }
        public virtual ICollection<KeyReloDetailService> KeyReloDetailServices { get; set; }
        public virtual ICollection<ReminderPredecisionOrientation> ReminderPredecisionOrientations { get; set; }
